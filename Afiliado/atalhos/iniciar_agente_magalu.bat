@echo off
setlocal
title Mega Descontos - Agente Magalu
cd /d "%~dp0.."
...
if not exist "config\magalu_automation_agent.json" (
...
echo Agente Magalu ativo. Esta janela pode ficar minimizada.
"%PYTHON_EXE%" bot\magalu_automation_agent.py
pause
